class DashboardController < ActionController::Base
  ...
  def platform_config
    ...
    {
      # EVO-CUSTOM: pelo EvolutionEndpoint, senao a tela de configuracao mostra
      # em branco enquanto o sistema usa o valor que veio do ambiente.
      EVOLUTION_API_URL: EvolutionEndpoint.api_url.to_s,
      EVOLUTION_ADMIN_SECRET: EvolutionEndpoint.admin_token.to_s,
      EVOLUTION_GO_API_URL: EvolutionEndpoint.go_api_url.to_s,
      EVOLUTION_GO_ADMIN_SECRET: EvolutionEndpoint.go_admin_token.to_s,
